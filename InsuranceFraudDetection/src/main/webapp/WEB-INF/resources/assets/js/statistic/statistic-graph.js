...
window.onload = function(){
   ...
   am4core.ready(function() {
      ...
      var checkText = $("<h4 style='color:#8181F7;'>(현황) ’19년 중 보험사기 적발금액은 8,809억원으로 전년(7,982억원) 대비 827억원(10.4%↑) 증가한 역대 최고 수준  -보험사기 대응단- </h4>" +
    		"<br>" +
      		"<h4 style='color:#FF0080;'>대다수의 보험사기(82%)가 1인당 평균 적발금액(9.5백만원) 미만으로비교적 소액의 보험사기</h4>" +
      		"<h5 style='color:#FF0080;'>  * 1백만원 이하 29.4%, 3백만원 이하 58.0%, 5백만원 이하 71.7%, 1천만원 이하 83.9% </h5>"+
      		"<h6>출처: <a href='https://www.fss.or.kr/fss/insucop/main.jsp'>금융감독원 보험사기방지센터</a></h6>")
      $("#chartContent").append(checkText)
      ...
      $("#selectArea2").css("display","none");
        ...
        lineSeries.stroke = am4core.color("#FF0080");
...
$("#cloudTag").on("click",function(){
   ...
   $("#selectArea").css("display","none");
     ...
     emptyContent(2);
     var Cloudtext = $("<h2> 머신러닝 모델링에서 중요도가 높은 변수 </h2><hr>")
     $("#chartText_sub").append(Cloudtext);
   am4core.ready(function() {
      ...
      var chart = am4core.create("chartdiv_sub", am4plugins_wordCloud.WordCloud);
      ...
      series.text = "의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사X병원 의사" +
      		...
      		"여자 질병X통원 전문직 총보험료 광주광역시 서비스 다가구주택 전라남도 단독주택 경상남도 재해X수술 부산 연립다가구주택 기혼 서울 배우자주부 미혼 비거주용건물 사무직 배우자서비스 주부 배우자사무직 서비스 전남 배우자자영업 제조업 아이수 여성 남성 서울 주부 재해x수술 재해x사망 교통x수술 1차산업 대전 경북 광주 서울 "+ 
...
//  나이 버튼 클릭시 보여줄 스크립트 코드
    $("#agebtn").hover(function(){
        ...
        $("#agebtn").on("click",function(){
         ...
         emptyContent(2);
         $("#chartText_sub").append("사기자의 성별&연령별 분포")   
         am4core.ready(function() {
...
$("#areabtn").hover(function(){
  ...
  $("#areabtn").on("click",function(){
   ...
   am4core.ready(function() {
     ...
     $("#chartText_sub2").append("사기자	의 직업 분포도")
     am4core.useTheme(am4themes_animated);
     // Themes end
   ...
   chart.legend = new am4charts.Legend();
     ...
     $("#test option:eq(0)").text("사기자")
     $("#test option:eq(1)").text("일반인")
   ...
   am4core.ready(function() {
     ...
     $("#chartText_sub3").append("사기자의 40~50대 직업 분포도")
   ...
   chart.legend = new am4charts.Legend();
     ...
     $("#test2").off().on("change",function(){
        ...
        if(option_value ==1){
           ...
           $("#chartText_sub3").empty()
           fadeEvent(3);
           $("#chartText_sub3").append("일반인의 40~50대  직업 분포도")
...
//         세번쨰 청구 사유 코드
    ...
    // 4번쨰 사기자이 많이 사용한 패턴
      emptyContent(4);
      $("#chartText_sub3").append("사기자의 사고유형과 청구사유");
      $("#chartContent_sub3").append("금융감독원 보험사기방지센터를 참조")
      $("#chart4").css("display","block");
      $("#chart2").css("display","block");
      am4core.ready(function() {
...
//주의  의사 top5
$("#dangerHos").hover(function(){
    $('html').css("cursor","pointer");
},function(){
   $('html').css("cursor","auto");
}) 
$("#dangerHos").on("click",function(){
	   textVal = $(this).text()
	   $("#title").text(textVal);
	   am4core.disposeAllCharts();
	   $("#chart2").css("display","block");
	   ...
	   $("#chartdiv").append("")
	   emptyContent(2);
	   $("#chartText_sub").append("유의병원 진료비율")
	   am4core.ready(function() {
	...
	// Themes begin
	   ...
	   am4core.ready(function() {
	      ...
	      var chart = am4core.create("chartdiv_sub2", am4charts.XYChart);
	      chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
	   ...
	   emptyContent(4);
	   $("#selectArea2").css("display","block");
	   $("#chartText_sub3").append("사기자의 주의 병원 방문 분포 ")
	   $("#chartContent_sub3").append("금감원 유의 병원 대상 여부")
	   am4core.ready(function() {
	      ...
	      chart.data = data1
	        $("#test2").off().on("change",function(){
	           ...
	           if(option_value ==1){
	              ...
	              $("#chartText_sub3").empty();
	              fadeEvent(3);
	              $("#chartText_sub3").append("일반인의 주의 병원 방문 분포");
...
$("#dangerDocAndHos").on("click",function(){
   ...
   am4core.ready(function() {
      ...
      chart.cursor.events.on("cursorpositionchanged", function (event) {
   	...
   	emptyContent(3);
    $("#selectArea").css("display","none")
    $("#chartText_sub2").append("유의의사 진료비율x유의병원 진료비율")
   	am4core.ready(function() {
...
$("#incomeBtn").on("click", function(){
   ...
   emptyContent(1);
    $("#chartText").append("납입한 최대 월 보험료 별 고객수 비율")     -
   am4core.ready(function() {
         ...
         series.name = "사기자";
         series.clustered = false;
         series.columns.template.tooltipText = "사기자 {premium} (보험료): [bold]{valueY}[/]";
         series.columns.template.fillOpacity = 0.9;
         series.fill = am4core.color("#FA5882");
         var series2 = chart.series.push(new am4charts.ColumnSeries3D());
         series2.dataFields.valueY = "일반인";
         ...
         series2.name = "일반인";
         series2.clustered = false;
         series2.columns.template.tooltipText = "일반인{premium} (보험료): [bold]{valueY}[/]";
         series2.fill = am4core.color("rgb(103, 148, 220)");
         }); // end am4core.ready()   
   ...
   emptyContent(2);
   $("#chartText_sub").append("납입한 총 보험료별 고객수 비율");
...
am4core.ready(function() {
   ...
   emptyContent(3);
   $("#chartText_sub2").append("개인추정 소득별 고객수 비율");
...
$("#arryTypeBtn").hover(function(){
    $('html').css("cursor","pointer");
},function(){
   $('html').css("cursor","auto");
})
$("#arryTypeBtn").on("click", function(){
   textVal = $(this).text()
   $("#title").text(textVal);  
    am4core.disposeAllCharts();
    $("#chart1").css("height","");
   ...
   $("#selectArea").css("display","block");
   emptyContent(4);
   $("#chartText_sub2").append("추정가구 소득(1)")
   $("#chartContent_sub2").append("고객의 주택가격을 우선하여 정한 가구소득 추정금액")
   am4core.ready(function() {
      ...
      $("#test option:eq(0)").text("소득(1)")
      $("#test option:eq(1)").text("소득(2)")
      $("#test").off().on("change",function(){
           var select = document.getElementById("test");
           var option_value = select.options[select.selectedIndex].value;
           var option_text   = select.options[select.selectedIndex].text;
           if(option_value ==1){
              ...
              $("#chartContent_sub2").empty()
              fadeEvent(2);
              $("#chartText_sub2").append("추정가구 소득(2)")
              $("#chartContent_sub2").append("고객의 직업 및 납입보험료 수준을 우선하여 정한 가구소득 추정금액")
