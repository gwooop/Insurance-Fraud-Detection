...
//	custManagerId별 서비스 페이지
	@GetMapping("/product/services/{custManagerId}")
	public String goServicePage(Claim claim, @PathVariable int custManagerId, Model model) {
...
//	신규 고객 정보 입력 페이지
	...
	public String goCustServicePage() {
		return "product/custServices";
	}
...
//	관리하는 고객 정보 페이지
	@GetMapping("/product/custManageServices/{custManagerId}/{custId}")
	public String custManagePage(@PathVariable int custManagerId, @PathVariable int custId, Model model) {
		try {
...
//	고객 정보 삭제
	...
	public String deleteCustId(@PathVariable int custManagerId, @PathVariable int custId) {
...
//	고객 정보 수정 완료
	@PostMapping("/product/custUpdate/{custManagerId}/{custId}")
	public String commitUpdatePage(Cust cust, @PathVariable int custManagerId, @PathVariable int custId, Model model) {
		productService.updateCustData(cust);
		return "redirect:/product/custManageServices/{custManagerId}/{custId}";
	}
